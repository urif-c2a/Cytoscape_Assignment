...
export const nodeElements = [
  ...
  // {  data: { id: 'mcuA', label: 'Mcu A', type: NODE_TYPES.MCU }, position: { x: 700, y: 400 }},
  // {  data: { id: 'mcuB', label: 'Mcu B', type: NODE_TYPES.MCU }, position: { x: 600, y: 300 }},
  // {  data: { id: 'mcuC', label: 'Mcu C', type: NODE_TYPES.MCU }, position: { x: 500, y: 500 }},
  // {  data: { id: 'mcuD', label: 'Mcu D', type: NODE_TYPES.MCU }, position: { x: 400, y: 100 }},

  // {  data: { id: 'edge1', source: 'mcuA', target: 'mcuB' }},
  // {  data: { id: 'edge2', source: 'mcuB', target: 'mcuC' }},
  // {  data: { id: 'edge3', source: 'mcuC', target: 'mcuD' }},
  // {  data: { id: 'edge4', source: 'mcuD', target: 'mcuA' }},
  // {  data: { id: 'edge5', source: 'mcuA', target: 'mcuC' }},
  // {  data: { id: 'edge6', source: 'mcuB', target: 'mcuD' }},
